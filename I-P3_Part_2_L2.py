...
file_prefix = 'L2_' + 'AUG_26_P3_REV_'
...
for gene in chosen_genes:
    ...
    for i in range(len(translated_reference_sequence_concatenate_STR)):
        ...
        if ((identity_test_codon_1 == 1).any()) & ((identity_test_codon_2 == 1).any()):
            if (identity_test_codon_1[identity_test_codon_1 == 1].index[0] == 'C') & (identity_test_codon_2[identity_test_codon_2 == 1].index[0] == 'T') & (amino_acid in 'L'):
                degenerate_count += 1
